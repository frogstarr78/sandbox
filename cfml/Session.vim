...
badd +5 index.cfm
badd +36 login.cfm
badd +67 Application.cfc
badd +1 components/User.cfc
badd +1 /tmp/file
badd +1 register.cfm
badd +1 script/auth.css
badd +1 javascript/form_magic.js
badd +11 style/auth.css
badd +9 do_register.cfm
badd +4 sql/schema.sql
args index.cfm login.cfm
...
silent! normal! zE
let s:l = 86 - ((36 * winheight(0) + 18) / 37)
